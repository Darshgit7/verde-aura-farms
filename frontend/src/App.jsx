...
const T = {
  en: {
    ...
    explore: "Explore",
    aboutLabel: "ABOUT VERDE AURA FARM",
    aboutTitle: (
      <>
  ...
  mr: {
    ...
    explore: "पुढे पहा",
    aboutLabel: "व्हेर्दे ऑरा फार्म बद्दल",
    aboutTitle: (
      <>
    ...
    aboutLead:
      "शेवगा शेती सुरू करण्यास आणि व्यवस्थापनास इच्छुक असलेल्या शेतकऱ्यांना व्हेर्दे ऑरा फार्म व्यावहारिक मार्गदर्शन देतो.",
    aboutText:
    ...
    farmText:
      "व्हेर्दे ऑरा फार्ममधील प्रत्यक्ष फोटो येथे पाहा — लागवड, पाणी व्यवस्थापन, पिकाची वाढ आणि शेतातील प्रत्यक्ष परिस्थिती.",
    gallery: [
      "शेतीचा परिसर",
      "शेवगा लागवड",
      "शेवग्याची फुले",
...
export default function App() {
  ...
  // Supports English and Marathi/Devanagari letters, with single spaces between words.
  const validateForm = () => {
    const nameRegex = /^[A-Za-z\u0900-\u097F]+(?: [A-Za-z\u0900-\u097F]+)*$/u;
    const mobileRegex = /^[0-9]{10}$/;
    const villageRegex =
      /^[A-Za-z\u0900-\u097F]+(?: [A-Za-z\u0900-\u097F]+)*$/u;

    if (!nameRegex.test(form.name.trim())) {
      return lang === "mr"
        ? "कृपया नावामध्ये फक्त अक्षरे आणि शब्दांमध्ये एकच स्पेस वापरा."
        : "Please enter a valid name using alphabets and single spaces only.";
    }

    if (!mobileRegex.test(form.mobile.trim())) {
      return lang === "mr"
        ? "कृपया फक्त 10 अंकी मोबाईल नंबर टाका."
        : "Please enter exactly a 10-digit mobile number.";
    }

    if (form.village.trim() && !villageRegex.test(form.village.trim())) {
      return lang === "mr"
        ? "कृपया गाव / शहराच्या नावामध्ये फक्त अक्षरे आणि शब्दांमध्ये एकच स्पेस वापरा."
        : "Please enter Village / City using alphabets and single spaces only.";
    }

    if (!form.service) {
      return lang === "mr"
        ? "कृपया तुम्हाला कोणती सेवा हवी आहे ते निवडा."
        : "Please select a service from Interested In.";
    }
    ...
    if (form.date) {
      ...
      if (selectedDate < today) {
        return lang === "mr"
          ? "कृपया आजची किंवा पुढील तारीख निवडा."
  ...
  // If a validation message is already visible, update it immediately when
  // the user switches between English and Marathi.
  useEffect(() => {
    if (!error) return;
